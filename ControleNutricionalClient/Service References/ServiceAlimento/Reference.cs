...
namespace ControleNutricionalClient.ServiceAlimento {
    ...
    public partial class Alimento : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private ControleNutricionalClient.ServiceAlimento.Grupo Grupo1Field;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public ControleNutricionalClient.ServiceAlimento.Grupo Grupo1 {
            get {
    ...
    public partial class Grupo : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private ControleNutricionalClient.ServiceAlimento.Alimento[] AlimentosField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public ControleNutricionalClient.ServiceAlimento.Alimento[] Alimentos {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ServiceAlimento.IServiceAlimento")]
    public interface IServiceAlimento {
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceAlimento/findall", ReplyAction="http://tempuri.org/IServiceAlimento/findallResponse")]
        ControleNutricionalClient.ServiceAlimento.Alimento[] findall();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceAlimento/findall", ReplyAction="http://tempuri.org/IServiceAlimento/findallResponse")]
        System.Threading.Tasks.Task<ControleNutricionalClient.ServiceAlimento.Alimento[]> findallAsync();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceAlimento/find", ReplyAction="http://tempuri.org/IServiceAlimento/findResponse")]
        ControleNutricionalClient.ServiceAlimento.Alimento find(string id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceAlimento/find", ReplyAction="http://tempuri.org/IServiceAlimento/findResponse")]
        System.Threading.Tasks.Task<ControleNutricionalClient.ServiceAlimento.Alimento> findAsync(string id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceAlimento/create", ReplyAction="http://tempuri.org/IServiceAlimento/createResponse")]
        bool create(ControleNutricionalClient.ServiceAlimento.Alimento alimento);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceAlimento/create", ReplyAction="http://tempuri.org/IServiceAlimento/createResponse")]
        System.Threading.Tasks.Task<bool> createAsync(ControleNutricionalClient.ServiceAlimento.Alimento alimento);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceAlimento/edit", ReplyAction="http://tempuri.org/IServiceAlimento/editResponse")]
        bool edit(ControleNutricionalClient.ServiceAlimento.Alimento alimento);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceAlimento/edit", ReplyAction="http://tempuri.org/IServiceAlimento/editResponse")]
        System.Threading.Tasks.Task<bool> editAsync(ControleNutricionalClient.ServiceAlimento.Alimento alimento);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceAlimento/delete", ReplyAction="http://tempuri.org/IServiceAlimento/deleteResponse")]
        bool delete(ControleNutricionalClient.ServiceAlimento.Alimento alimento);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceAlimento/delete", ReplyAction="http://tempuri.org/IServiceAlimento/deleteResponse")]
        System.Threading.Tasks.Task<bool> deleteAsync(ControleNutricionalClient.ServiceAlimento.Alimento alimento);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServiceAlimentoChannel : ControleNutricionalClient.ServiceAlimento.IServiceAlimento, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServiceAlimentoClient : System.ServiceModel.ClientBase<ControleNutricionalClient.ServiceAlimento.IServiceAlimento>, ControleNutricionalClient.ServiceAlimento.IServiceAlimento {
        
        public ServiceAlimentoClient() {
        }
        
        public ServiceAlimentoClient(string endpointConfigurationName) : 
                base(endpointConfigurationName) {
        }
        
        public ServiceAlimentoClient(string endpointConfigurationName, string remoteAddress) : 
                base(endpointConfigurationName, remoteAddress) {
        }
        
        public ServiceAlimentoClient(string endpointConfigurationName, System.ServiceModel.EndpointAddress remoteAddress) : 
                base(endpointConfigurationName, remoteAddress) {
        }
        
        public ServiceAlimentoClient(System.ServiceModel.Channels.Binding binding, System.ServiceModel.EndpointAddress remoteAddress) : 
                base(binding, remoteAddress) {
        }
        
        public ControleNutricionalClient.ServiceAlimento.Alimento[] findall() {
            return base.Channel.findall();
        }
        
        public System.Threading.Tasks.Task<ControleNutricionalClient.ServiceAlimento.Alimento[]> findallAsync() {
            return base.Channel.findallAsync();
        }
        
        public ControleNutricionalClient.ServiceAlimento.Alimento find(string id) {
            return base.Channel.find(id);
        }
        
        public System.Threading.Tasks.Task<ControleNutricionalClient.ServiceAlimento.Alimento> findAsync(string id) {
            return base.Channel.findAsync(id);
        }
        
        public bool create(ControleNutricionalClient.ServiceAlimento.Alimento alimento) {
            return base.Channel.create(alimento);
        }
        
        public System.Threading.Tasks.Task<bool> createAsync(ControleNutricionalClient.ServiceAlimento.Alimento alimento) {
            return base.Channel.createAsync(alimento);
        }
        
        public bool edit(ControleNutricionalClient.ServiceAlimento.Alimento alimento) {
            return base.Channel.edit(alimento);
        }
        
        public System.Threading.Tasks.Task<bool> editAsync(ControleNutricionalClient.ServiceAlimento.Alimento alimento) {
            return base.Channel.editAsync(alimento);
        }
        
        public bool delete(ControleNutricionalClient.ServiceAlimento.Alimento alimento) {
            return base.Channel.delete(alimento);
        }
        
        public System.Threading.Tasks.Task<bool> deleteAsync(ControleNutricionalClient.ServiceAlimento.Alimento alimento) {
            return base.Channel.deleteAsync(alimento);
        }
    }
}
